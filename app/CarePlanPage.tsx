...
export default function CarePlanPage() {
  return (
    <div className="p-8">
      <h3 className="text-2xl font-semibold text-foreground mb-8">Your Personalized Care Plan</h3>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border p-6 hover:shadow-md hover:border-border/60 transition-all duration-300">
          <h4 className="text-lg font-semibold text-foreground mb-4">Medications</h4>
        ...
        {/* Diet */}
        <div className="bg-card rounded-lg shadow-sm border border-border p-6 hover:shadow-md hover:border-border/60 transition-all duration-300">
          <h4 className="text-lg font-semibold text-foreground mb-4">Diet Plan</h4>
          <div className="space-y-4">
        ...
        {/* Activity */}
        <div className="bg-card rounded-lg shadow-sm border border-border p-6 hover:shadow-md hover:border-border/60 transition-all duration-300">
          <h4 className="text-lg font-semibold text-foreground mb-4">Daily Activity</h4>
          <div className="space-y-4">
      ...
      <div className="mt-8 bg-warning/10 border border-warning/30 rounded-lg p-6">
        <div className="flex gap-3 mb-3">
          ...
          <h4 className="text-lg font-semibold text-foreground">Follow-up Reminders</h4>
        </div>
        <ul className="text-foreground/80 space-y-2 ml-9 text-sm">
