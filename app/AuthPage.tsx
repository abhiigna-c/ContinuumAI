    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <button
          ...
          className="mb-6 flex items-center gap-2 text-primary hover:text-primary"
        >
          <ArrowLeft size={20} /> Back
        </button>

        <div className="bg-card rounded-lg shadow-sm border border-primary/15 p-8">
          <h2 className="text-2xl font-bold text-foreground mb-6">
            {isSignUp ? "Create Account" : "Sign In to ContinuumAI"}
          </h2>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-border rounded-lg bg-input text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary focus:border-transparent"
                    required
                  />
                </div>
